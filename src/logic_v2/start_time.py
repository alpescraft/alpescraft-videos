...
def get_relative_start_time(reference_file_path: str, other_file_path: str, start_seconds_in_reference_file: float) -> float:
    presentation_ctime = get_created_date(reference_file_path)
    slides_ctime = get_created_date(other_file_path)
    ...
    slides_relative_start = get_offset_seconds(slides_ctime.timestamp(), start_seconds_in_reference_file,
